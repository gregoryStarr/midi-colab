  ...
  return (
    <div className="relative group">
      ...
      <div className="absolute inset-0 -z-10">
        ...
        <div
          className="absolute top-1/2 left-0 right-0 h-px bg-gradient-to-r from-transparent via-pink-400/20 to-transparent animate-pulse-slow"
          style={{ transform: "translateY(20px)" }}
        ></div>
        <div
          className="absolute top-1/2 left-0 right-0 h-px bg-gradient-to-r from-transparent via-cyan-400/20 to-transparent animate-pulse-slow"
          style={{ transform: "translateY(-20px)" }}
        ></div>
        ...
        <div className="flex items-center justify-between mb-8 relative z-10">
          <div className="flex items-center space-x-6">
            ...
            <div className="relative group/logo">
              <div className="w-20 h-20 bg-gradient-to-br from-cyan-400 via-purple-500 to-pink-500 rounded-3xl flex items-center justify-center shadow-2xl shadow-purple-500/50 transform group-hover/logo:scale-110 transition-all duration-700 relative z-10">
                <span className="text-white font-display text-5xl drop-shadow-2xl animate-pulse-glow">
                  ♪
                </span>
              </div>
              ...
              <div
                className="absolute inset-0 bg-gradient-to-br from-pink-400 to-orange-400 rounded-3xl blur-2xl opacity-40 animate-pulse scale-125"
                style={{ animationDelay: "0.3s" }}
              ></div>

              {/* Musical note accents */}
              <div className="absolute -top-2 -right-2 text-cyan-300 animate-bounce opacity-80">
                ♪
              </div>
              <div
                className="absolute -bottom-1 -left-1 text-purple-300 animate-bounce opacity-60"
          ...
          <div className="flex items-center space-x-8 relative z-10">
            ...
            <div className="text-center">
              ...
              <div className="text-sm font-bold text-cyan-400 tracking-wider uppercase">
                Active Notes
              </div>
              ...
              <div className="text-center relative z-10">
                ...
                <div className="relative mb-8 inline-block">
                  <div className="w-24 h-24 bg-gradient-to-br from-cyan-400 to-purple-500 rounded-3xl flex items-center justify-center shadow-2xl shadow-cyan-500/40 animate-pulse">
                    <span className="text-white text-6xl drop-shadow-xl">
                      🎹
                    </span>
                  </div>
                ...
                <p className="text-lg text-gray-300 mb-8 max-w-md mx-auto leading-relaxed">
                  Setting up the music engine and connecting to the
