...
export function RightSidebar({ volume, setVolume, soundType, setSoundType, onTestSound }: RightSidebarProps) {
  
  // Custom vertical slider component
  const VerticalSlider = ({ label, value, onChange }: { label: string, value: number, onChange: (v: number) => void }) => (
